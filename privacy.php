 ...
 <main class="sub-page">
   ...
   <!-- sub page content -->
    <section class="subpage-content">       
        <div class="container">     
            <p>Surechain values the trust you place on us. That’s why we insist upon the highest standards for secure transactions and customer information privacy. Please read the following statement to learn about our information gathering and dissemination practices. </p>
            <p>Note: To make sure you are aware of any changes, please review this policy periodically, as this policy is subject to change without any notice. </p>
            <p>By visiting our website (https://www.surechain.ai) you agree to be bound by the terms and conditions of this Privacy Policy. If you do not agree please do not use or access our Website. </p>
            ...
            <p>If we decide to change our privacy policy, we will post those changes on this page so that you are always aware of what information we collect, how we use it, and under what circumstances we disclose it. This Privacy Policy is incorporated into and subject to the Terms of Use. </p>
            <h5>Collection of Personally Identifiable Information and other Information</h5>
            <p>Personal data is retained only for as long as necessary to fulfil the purposes outlined in this policy or as required by Indian law. Users may request deletion of their data by contacting our Grievance Officer. When you use our website, we collect and store your personal information which is provided by you from time to time. Our primary goal in collecting your personal information is to provide you a safe, efficient, smooth and customised</p>
            <p>experience. This allows us to provide services and features that most likely meet your needs, and to customise our website to make your experience safer and easier. More importantly, while doing so we collect your personal information from you that we consider necessary and sufficient for achieving this purpose. </p>
...
If you transact with us, we collect some additional information, such as a billing address, a credit / debit card number and a credit / debit card expiration date and/ or other payment instrument details and tracking information from cheques or money orders. </p>
...
<p>We collect personally identifiable information (email address, name, phone number, credit card / debit card / other payment instrument details, etc.) from you when you set up a free account with us. While you can browse some sections of our Website without being a registered member, certain activities (such as placing an order) do require registration. We do use your contact information to send you offers based on your previous orders and your interests. </p>
 ...
 <p>We use data collection devices such as “cookies” on certain pages of the Website to help analyse our web page flow, measure promotional effectiveness, and promote trust and safety. A “cookie” is a small piece of information stored by a web server on a web browser so it can be later read back from that browser. Cookies are useful for enabling the browser to remember information specific to a given user. We place both permanent and temporary cookies in your computer’s hard drive. The cookies do not contain any of your personally identifiable information. </p>
  ...
  <p>We may share personal information with our other corporate entities and affiliates. These entities and affiliates may market to you because of such sharing unless you explicitly opt-out. </p>
  <p>Surechain may share personal data with third-party service providers for purposes such as payment processing and order fulfilment. All such sharing is conducted under strict confidentiality agreements, and user consent is obtained where necessary. This disclosure may be required for us to provide you access to our Services, to comply with our legal obligations, to enforce our User Agreement, to facilitate our marketing and advertising activities, for service recovery purposes, or to prevent, detect, mitigate, and investigate fraudulent or illegal activities related to our Services. We do not disclose your personal information to third parties for their marketing and advertising purposes without your explicit consent. </p>
  ...
  <p>We and our affiliates will share / sell some or all your personal information with another business entity should we (or our assets) plan to merge with, or be acquired by that business entity, or re-organization, amalgamation, restructuring of business. Should such a transaction occur that other business entity (or the new combined entity) will be required to follow this privacy policy with respect to your personal information. </p>
    ...
    <p>Our website links to other websites that may collect personally identifiable information about you. Our website (https://www.surechain.ai) is not responsible for the privacy practices or the content of those linked websites. </p>
    ...
    <p>We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications from us on behalf of our partners, and from us in general, after setting up an account.  </p>
       ...
       <h5>Advertisements on our website: https://www.surechain.ai</h5>
    <p>We use third-party advertising companies to serve advertisements when you visit our Website. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other websites in order to provide advertisements about goods and services of interest to you.  </p>

     <h5>Grievance Officer</h5>
    <p>For any concerns or complaints regarding your personal data, please contact our Grievance Officer. In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below: </p>
    <p>Mr. / Ms. ____________________ <br>

Alqon Innovations Private Limited <br>

No. 15-31-VH-OP-59 & 60,/4F, Plot no. 59 & 60<br>
KPHB Colony, Tirumalagiri,  <br>
...
Telangana </p>
 ...
 <h5>9.Questions? </h5>
    <p>Questions regarding this statement should be directed to support team by raising an incident from your seller dashboard </p>
        </div>
    </section>
 </main>
 <!-- main content ends -->
