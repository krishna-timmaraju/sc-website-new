                        ...
                        <div class="col-md-6">
                            <div class="buyer-form bg-white p-4 rounded">
                                ...
                                <form class="pt-4">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="firstlastname" placeholder="Write your Name">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="phone">Email id <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="form-floating mb-3">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Describe Your Product Requirement" id="product-describe" style="height: 100px"></textarea>
                                        <label for="floatingTextarea2">Describe Your Product Requirement</label>
                                    </div>
                                </form>
                                <p class="small pt-3" style="line-height: 20px;"><small>The personal data shared by you will be used by Surechain to connect with you directly or through its affiliates and partners.</small></p>
